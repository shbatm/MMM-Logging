...
When an incident does occur, it is important to report it promptly. To report a possible violation, **contact shbatm via the forum: <https://forum.magicmirror.builders/user/shbatm>**. If you are unable to contact shbatm, you can also contact the MagicMirror² community moderators at <https://github.com/MagicMirrorOrg/MagicMirror/blob/master/.github/CODE_OF_CONDUCT.md#enforcement>.
